...
{    end else begin
 ...
 if (MultiviewMask=0) and fMeshShader and assigned(fVulkanPipelineShaderStageLayerRoutingTask) and assigned(fVulkanPipelineShaderStageLayerRoutingMesh) then begin
