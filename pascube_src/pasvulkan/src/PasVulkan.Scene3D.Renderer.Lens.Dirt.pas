...
begin
 ...
 aVulkanDevice.DebugUtils.SetObjectName(fVulkanImage.Handle,VK_OBJECT_TYPE_IMAGE,'TpvScene3DRendererLensDirt.Image');
 ...
 fMemoryBlock:=aVulkanDevice.MemoryManager.AllocateMemoryBlock(MemoryBlockFlags,
                                                               ...
                                                               'TpvScene3DRendererLensDirt.MemoryBlock');
  ...
  try
   ...
   try
    ...
    fVulkanImageView:=TpvVulkanImageView.Create(aVulkanDevice,
                                                ...
                                                0,
                                                1);
    aVulkanDevice.DebugUtils.SetObjectName(fVulkanImageView.Handle,VK_OBJECT_TYPE_IMAGE_VIEW,'TpvScene3DRendererLensDirt.ImageView');
