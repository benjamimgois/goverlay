...
begin
 ...
 if fInstance.Scene3D.EnableWater then begin
  if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
   Stream:=pvScene3DShaderVirtualFileSystem.GetFile('blend_resolve_water_frag.spv');
  end else begin
   if fInstance.Renderer.SupersampleWaterWhenMSAA then begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('blend_resolve_water_msaa_frag.spv');
   end else begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('blend_resolve_water_msaa_no_msaa_water_frag.spv');
   end;
  end;
 end else begin
  if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
