 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.ResamplingRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesResamplingRenderPass }
      TpvScene3DRendererPassesResamplingRenderPass=class(TpvFrameGraph.TRenderPass)
       private
...
{ TpvScene3DRendererPassesResamplingRenderPass }


constructor TpvScene3DRendererPassesResamplingRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesResamplingRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesResamplingRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
...
procedure TpvScene3DRendererPassesResamplingRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesResamplingRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesResamplingRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesResamplingRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesResamplingRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
...
begin
 ...
 if assigned(fInstance.Renderer.VulkanDevice.BreadcrumbBuffer) then begin
  fInstance.Renderer.VulkanDevice.BreadcrumbBuffer.BeginBreadcrumb(aCommandBuffer.Handle,TpvVulkanBreadcrumbType.Draw,'ResamplingRenderPass');
 end;
