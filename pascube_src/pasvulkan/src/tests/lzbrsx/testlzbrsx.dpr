...
begin
 ...
 if LZBRSXCompress(UncompressedData,UncompressedSize,CompressedData,CompressedSize,TpvLZBRSXLevel(5)) then begin
...
procedure TestLZBRSXDecompress;
var InputFileStream:TFileStream;
    OutputFileStream:TFileStream;
    CompressedSize:TpvUInt64;
    UncompressedSize:TpvUInt64;
...
begin
 ...
 if LZBRSXDecompress(CompressedData,CompressedSize,UncompressedData,UncompressedSize) then begin
...
begin
 ...
 if LZBRSXCompress(OriginalData,OriginalSize,CompressedOriginalData,CompressedOriginalSize,TpvLZBRSXLevel(5),false) then begin
  if LZBRSXDecompress(CompressedOriginalData,CompressedOriginalSize,UncompressedCompressedData,UncompressedCompressedSize,OriginalSize,false) then begin
