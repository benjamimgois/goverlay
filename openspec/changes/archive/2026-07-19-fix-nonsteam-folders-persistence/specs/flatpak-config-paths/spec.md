...
#### Scenario: Resolve GOverlay config dir inside Flatpak
- **WHEN** GOverlay runs inside Flatpak and `$XDG_CONFIG_HOME` is set to "/home/user/.var/app/io.github.benjamimgois.goverlay/config"
- **THEN** TConfigManager.GetGoverlayFolder returns "/home/user/.var/app/io.github.benjamimgois.goverlay/config/goverlay"
