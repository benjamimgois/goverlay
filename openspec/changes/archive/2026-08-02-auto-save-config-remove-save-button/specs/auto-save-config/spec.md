...
GOverlay SHALL automatically save configuration changes to disk whenever the user modifies a UI control (checkbox, radio button, combobox, slider, or text input) on any active tab.
...
- **WHEN** user drags a slider or types in a text box
